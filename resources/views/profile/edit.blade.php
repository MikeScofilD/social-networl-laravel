            ...
            <form method="POST" action="{{ route('profile.edit') }}" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="first_name"
                        ...
                        placeholder="Например Василий" value="{{Request::old('first_name') ?: Auth::user()->first_name}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="last_name"
                        ...
                        placeholder="Например Vasia Puplin" value="{{Request::old('last_name') ?: Auth::user()->last_name}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="location"
                        ...
                        placeholder="Например London" value="{{Request::old('location') ?: Auth::user()->location}}">
